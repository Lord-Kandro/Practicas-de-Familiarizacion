...
namespace PracticasEspecializacion.Controllers
{
    public class AgendaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdAgenda,paciente,Fecha,observacion")] Agenda agenda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAgenda,paciente,Fecha,observacion")] Agenda agenda)
        {
